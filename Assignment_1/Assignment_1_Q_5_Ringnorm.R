#Below is the code for ringnorm dataset
input = read.csv(file="ringnorm_data.csv", header=FALSE, sep=",")
input = input[,-c(1)] 
normalized_input = scale(input)
class(normalized_input)
...
{
  kmeans_output <- kmeans(normalized_input,i)
...
# The drop from k=2 to k=3 is (141245.9 - 138062.5) = 3183.4 units
